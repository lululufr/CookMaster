...
Route::get('/plan/purchase/{plan}', [PlanController::class,'purchase_plan'])->middleware('auth');
Route::post('/plan/purchase/{plan}', [PlanController::class,'pay_plan'])->middleware('auth');
